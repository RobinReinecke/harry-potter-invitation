...
export default function Letter() {
  ...
  return (
    ...
    >
      <div
        className={`font-letter leading-8 font-semibold p-10 shadow-[35px_35px_60px_-15px_rgba(0,0,0,0.3)] sm:w-screen h-full md:h-[1000px] md:w-[736px] ${styles.background}`}
      >
